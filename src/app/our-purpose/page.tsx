...
export default function OurPurpose() {
  return (
    <>
      <PageHero
        title="Our Purpose"
        subtitle="Defining Excellence in Real Estate Finance"
        description="Our vision is to define the standard of excellence for real estate financing in Canada. We are built to move fast, structure creatively, and lend with confidence."
          ...
          <div className="mb-16">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="text-center group">
                ...
                <p className="text-muted-foreground">
                  We continuously innovate to provide creative solutions that
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      We&apos;re committed to supporting projects that
                      contribute positively to Canadian communities and economic
                      growth.
                    </p>
                  </div>
                </div>
