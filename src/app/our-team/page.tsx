    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <ScrollAnimation>
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-semibold mb-6">Our Team</h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Our experienced team combines deep market knowledge with responsive
            underwriting, enabling us to quickly assess lending opportunities
            and deliver efficient closings.
          </p>
        </div>
      </ScrollAnimation>
        ...
        <div className="mb-16">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="text-center group">
              ...
              <p className="text-muted-foreground">
                We conduct business with honesty, transparency, and the highest
                ethical standards.
              </p>
            </div>
          </div>
