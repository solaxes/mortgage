      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <div className="grid gap-12 lg:grid-cols-2 items-center">
          ...
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-semibold tracking-tight animate-[fadeInUp_1s_ease-out_0.2s_both]">
              {title}
            </h1>
            {subtitle && (
              <p className="mt-5 text-base md:text-lg text-muted-foreground max-w-2xl animate-[fadeInUp_1s_ease-out_0.4s_both]">
                {subtitle}
              </p>
            )}
            <div className="mt-8 flex flex-wrap gap-3 animate-[fadeInUp_1s_ease-out_0.6s_both]">
          ...
          <div className="relative">
            <div className="relative rounded-2xl border bg-gradient-to-br from-primary/10 to-primary/5 p-8 backdrop-blur-sm">
              {/* Floating stats cards */}
              <div className="absolute -top-4 -right-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 animate-[float_3s_ease-in-out_infinite]">
                <div className="text-2xl font-bold text-primary">$2.0B+</div>
                <div className="text-xs text-muted-foreground">
                  Total Funded
                </div>
              </div>

              <div className="absolute -bottom-4 -left-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 animate-[float_3s_ease-in-out_infinite_1s]">
              ...
              <div className="text-center">
                <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-r from-primary to-primary/80 flex items-center justify-center animate-[pulse_2s_ease-in-out_infinite]">
